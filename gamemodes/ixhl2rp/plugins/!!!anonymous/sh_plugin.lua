...
if CLIENT then
	...
	do
		...
		playerMeta.SteamID = playerMeta.GetAnonID
		playerMeta.SteamID64 = playerMeta.GetAnonID
		...
		player.GetBySteamID64 = player.GetBySteamID
		util.SteamIDTo64 = util.SteamIDFrom64
	end
else
