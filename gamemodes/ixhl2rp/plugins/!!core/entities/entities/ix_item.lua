...
function ENT:SetupDataTables()
	...
	if CLIENT then
		self:NetworkVarNotify("ItemID", self.OnInstanced)
	end
end
...
if (SERVER) then
	...
	function ENT:Think()
		...
		if (!self.ixInstanced and itemTable and itemTable.OnEntityInstanced) then
			itemTable:OnEntityInstanced(self)
			self.ixInstanced = true
		end
	end
end
