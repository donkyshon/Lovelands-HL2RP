...
function Schema:CreateCharacterInfo(panel)
	panel.apart = panel:Add("ixListRow")
	panel.apart:SetList(panel.list)
	panel.apart:Dock(TOP)
	panel.apart:DockMargin(0, 0, 0, 8)
...
function Schema:UpdateCharacterInfo(panel)
	panel.apart:SetLabelText(L("house"))
	panel.apart:SetText(string.format("%s", LocalPlayer():GetCharacter():GetData("house") or "UNKNOWN"))
	panel.apart:SizeToContents()
